...
import com.leidos.lanemerge.appcommon.version.VehicleApplicationVersion;
...
public class LoggerManager {
    ...
    /**
     * Create or retrieve an instance of an {@link com.leidos.lanemerge.logger.ILogger} implementation for class origin.
     ...
     * @param listener The {@link com.leidos.lanemerge.logger.LogListener} object to be registered
     */
    ...
    /**
     * Only LogEntries more severe than min will be written to output file. Severity is defined in {@link com.leidos.lanemerge.logger.LogEntry.Level}.
     ...
     * {@link com.leidos.lanemerge.logger.LogBuffer} to filter {@link com.leidos.lanemerge.logger.LogEntry}s based on
