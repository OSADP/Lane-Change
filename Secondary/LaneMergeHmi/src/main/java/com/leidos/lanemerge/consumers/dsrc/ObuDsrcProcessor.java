...
public class ObuDsrcProcessor implements Runnable {
    ...
    public ObuDsrcProcessor(){
        ...
        this.obuUdpInPort = LaneMergeApplicationContext.getInstance().getAppConfig().getIntValue("asd.inport");

        this.mabUdpOutPort = LaneMergeApplicationContext.getInstance().getAppConfig().getIntValue("mab.dsrc.outport");
