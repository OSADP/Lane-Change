...
/**
 * AppConfig using lanemerge.properties instead of application.properties
 *
 * Provide a mechanism for external configuration via a lanemerge.properties outside the jar in the current directory.
 *
 * Using a lanemerge.properties file in the same directory as the jar overrides the default properties set inside the jar.
 */
@Configuration
@PropertySource( value = { "classpath:/lanemerge.properties", "file:lanemerge.properties" }, ignoreResourceNotFound = true )
